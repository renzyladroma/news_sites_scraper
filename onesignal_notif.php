...
$stmt1 = "SELECT headline, image FROM rss_content WHERE category_id = '1' AND fetch_date >= CURDATE() LIMIT 1";
...
$response = sendMessage($headline, $image);
...
function sendMessage($headline, $image){
