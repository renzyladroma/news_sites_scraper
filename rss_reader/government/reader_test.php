...
$feed_url="http://www.philstar.com/rss/nation";
...
try
{
	...
	$RSS_DOC = simpleXML_load_file('http://www.philstar.com/rss/nation');
	...
	foreach($RSS_DOC->channel->item as $RSSitem)
	{
		...
		$item_exists_sql = "SELECT item_id FROM abaka_db.rss_reader_test where item_id = '" . $item_id . "'";
		...
		if(mysql_num_rows($item_exists)<1)
		{
			...
			$item_insert_sql = "INSERT INTO abaka_db.rss_reader_test(category_id, item_id, feed_url, item_title, item_date, item_url, fetch_date, source)
			VALUES ('5', '" . $item_id . "', '" . $feed_url . "', '" . $item_title . "', '" . $item_date . "', '" . $item_url . "', '" . $fetch_date . "', 'Philippine Star') ";
