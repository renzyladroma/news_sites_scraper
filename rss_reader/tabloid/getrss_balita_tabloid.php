...
$feed_url="http://balita.net.ph/feed/";
...
try
{
	...
	$RSS_DOC = simpleXML_load_file('http://balita.net.ph/feed/');
	...
	foreach($RSS_DOC->channel->item as $RSSitem)
	{
		...
		if(mysql_num_rows($item_exists)<1)
		{
			...
			$item_insert_sql = "INSERT INTO abaka_db.rssingest(category_id, item_id, feed_url, item_title, item_date, item_url, fetch_date)
			VALUES ('1', '" . $item_id . "', '" . $feed_url . "', '" . $item_title . "', '" . $item_date . "', '" . $item_url . "', '" . $fetch_date . "')";
