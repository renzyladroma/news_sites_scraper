...
<?php
$feed_url="http://www.interaksyon.com/feed/";
...
try{
	...
	foreach($RSS_DOC->channel->item as $RSSitem){
		...
		if($result->num_rows < 1){
			...
			$item_insert_sql = "INSERT INTO rssingest2(category_id, item_id, feed_url, item_title, item_date, item_url, fetch_date, source)
			VALUES ('1', '" . $item_id . "', '" . $feed_url . "', '" . $item_title . "', '" . $item_date . "', '" . $item_url . "', '" . $fetch_date . "', 'TV5') ";
