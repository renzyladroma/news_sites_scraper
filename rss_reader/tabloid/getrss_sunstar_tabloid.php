...
$feed_url="http://www.philstar.com/rss/psn-showbiz";
...
try
{
	...
	$RSS_DOC = simpleXML_load_file('http://www.philstar.com/rss/psn-showbiz');
	...
	foreach($RSS_DOC->channel->item as $RSSitem)
	{
		...
		if(mysql_num_rows($item_exists)<1)
		{
			...
			$item_insert_sql = "INSERT INTO abaka_db.rssingest(category_id, item_id, feed_url, item_title, item_date, item_url, fetch_date, source)
														VALUES ('1', '" . $item_id . "', '" . $feed_url . "', '" . $item_title . "', '" . $item_date . "', '" . $item_url . "', '" . $fetch_date . "', 'Philippine Star')";
