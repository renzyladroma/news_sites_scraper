...
ON t1.item_url = t2.item_url AND t1.headline != '' AND t1.content != '' AND t1.image != '' AND t1.category_id = t3.category_id WHERE t1.category_id = '5' AND t1.fetch_date >= CURDATE() ORDER BY t1.image DESC";
...
INNER JOIN rssingest2 t2 
INNER JOIN rss_category t3
ON t1.item_url = t2.item_url AND t1.headline != '' AND t1.content != '' AND t1.image != '' AND t1.category_id = t3.category_id WHERE t1.category_id = '5' AND t1.fetch_date >= CURDATE()$date2 ORDER BY t1.image DESC";
